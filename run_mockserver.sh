...
prep_term
runCommand "java ${JVM_OPTIONS} -Dfile.encoding=UTF-8 -Dmockserver.initializationJsonPath=/opt/mockserver/totalConfig.json -jar /opt/mockserver/mockserver-netty-jar-with-dependencies.jar ${COMMAND_LINE_OPTS} &"
wait_term
